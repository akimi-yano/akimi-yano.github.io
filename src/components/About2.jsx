              ...
              <div style={{flexWrap: "wrap"}} className="row valign-wrapper">
                ...
                <h4 className="white-text">My career as a Software Engineer</h4>
                        <p className="flow-text white-text">
                            ...
                            number of tech professionals, and <span style={{color: "rgb(266,206,61)"}}>I got inspired by their ability to turn ideas into reality.</span> At the
                            same time, I started confirming the possibility of myself doing the same thing: creating things I could
                            only imagine.
                        </p>
                </div>
                <div style={{minHeight: "400px"}} className="col s12 m6 pull-m6 about-left black-text center-align">
                    <Animation/>
