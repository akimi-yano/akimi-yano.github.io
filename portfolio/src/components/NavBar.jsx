            ...
            <nav className="noboxshadow banner-hidden">
                ...
                {/* <a href="" data-activates="mobile-demo" className="button-collapse"><ViewListIcon/></a> */}
                    ...
                    <ul style={{margin: '0 20px'}} className="right hide-on-med-and-down">
                        <li ><a className="navlink blackfont aboutbtn" href="#about"><PersonIcon style={{marginBottom:'-4px'}}/> About </a></li>
                ...
                <li><a id="project4btn" href="#project4" className="blackfont">4. Climbing Analysis</a></li>
                        ...
                        <li ><a className="navlink blackfont techbtn" href="#skills"><SettingsIcon style={{marginBottom:'-4px'}}/> Skills </a></li>
                        <li ><a className="navlink blackfont contactbtn" href="#contact"><EmailIcon style={{marginBottom:'-4px'}}/> Contact </a></li>
                    </ul>
                </div>
            </nav>
        </div>
